...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  Widget build(BuildContext context) {
    return loading ? Loading() : Scaffold(
        ...
        appBar: SignCustomAppBar(nameOfPage: "Registrati",),
        body: InkWell(
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                child: Center(
                                  ...
                                  validator: (val) => val.isEmpty ? 'Inserire il tuo nome' : null,
                                  onChanged: (val) => {
                                    setState(() => nome = val)
                                  },
                                  maxLines: 1,
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                child: Center(
                                  ...
                                  validator: (val) => val.isEmpty ? 'Inserire il tuo cognome' : null,
                                  onChanged: (val) => {
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                child: Center(
                                  ...
                                  validator: (val) => val.isEmpty ? 'Inserire la tua password' : val.length < 6 ? "Inserisci una password con più di 6 caratteri" : null,
                                  onChanged: (val) => {
                            ...
                            child: Material(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async{
                                    ...
                                    dynamic result = await _authService.registerWithEmailAndPassword(nome, cognome, email, password);
                                    if(result == null){
                                      setState(() {
                                        loading = false;
                                        error = "Non è possibile creare un account con questi dati";
                                      });
                                    }
                                  }
                                },
