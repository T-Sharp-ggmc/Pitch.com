import 'package:WeCanTry/models/account.dart';
...
class TextToEdit extends StatefulWidget {
  ...
  const TextToEdit({Key key, this.accountInfo, this.callback}) : super(key: key);
...
class _TextToEditState extends State<TextToEdit> {
  ...
  Widget build(BuildContext context) {
    ...
    textController.text =  widget.accountInfo.infoDescription is int ? "CAP" 
    : widget.accountInfo.infoDescription is Sex ? "Sesso"
